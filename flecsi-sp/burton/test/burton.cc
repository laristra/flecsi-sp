...
////////////////////////////////////////////////////////////////////////////////
void dump_test( utils::client_handle_r_u<mesh_t> mesh ) {
...
////////////////////////////////////////////////////////////////////////////////
void validity_test( utils::client_handle_r_u<mesh_t> mesh ) {
...
////////////////////////////////////////////////////////////////////////////////
void connectivity_test( utils::client_handle_r_u<mesh_t> mesh ) {
...
////////////////////////////////////////////////////////////////////////////////
void geometry_test( utils::client_handle_r_u<mesh_t> mesh ) {
...
////////////////////////////////////////////////////////////////////////////////
void normals_test( utils::client_handle_r_u<mesh_t> mesh ) {
...
////////////////////////////////////////////////////////////////////////////////
void subset_test( utils::client_handle_r_u<mesh_t> mesh ) {
...
void state_fill_test(
  utils::client_handle_r_u<mesh_t> mesh,
  utils::dense_handle_w_u<real_t> cell_data,
  utils::dense_handle_w_u<data_t> face_data,
  utils::dense_handle_w_u<vector_t> edge_data,
  utils::dense_handle_w_u<array_t> vert_data
) {
...
void state_check_test(
  utils::client_handle_r_u<mesh_t> mesh,
  utils::dense_handle_r_u<real_t> cell_data,
  utils::dense_handle_r_u<data_t> face_data,
  utils::dense_handle_r_u<vector_t> edge_data,
  utils::dense_handle_r_u<array_t> vert_data
) {
...
////////////////////////////////////////////////////////////////////////////////
void extras_test( utils::client_handle_r_u<mesh_t> mesh ) {
...
void extra_state_fill_test(
  utils::client_handle_r_u<mesh_t> mesh,
  utils::dense_handle_w_u<int> wedge_data,
  utils::dense_handle_w_u<double> corner_data
) {
...
void extra_state_check_test(
  utils::client_handle_r_u<mesh_t> mesh,
  utils::dense_handle_r_u<int> wedge_data,
  utils::dense_handle_r_u<double> corner_data
) {
